                ...
                <div className='flex flex-col justify-start items-start gap-4'>
                    ...
                    <div className='shadow-xl z-50 flex flex-col justify-center items-start gap-8 shadow-black/40 rounded-2xl bg-bg-color p-6 xs:max-4xl:p-10'>
                        ...
                        <form onSubmit={handleReviewSubmit} className='flex flex-col gap-4' action="">
                            ...
                            <textarea style={{ resize: 'none' }} className='max-w-full w-44 xs:w-52 md:max-4xl:w-full px-5 py-3 rounded-2xl outline-none border-none focus:outline-none focus:border-none' placeholder="Type a review..." name="reviewContent" id="reviewContent" cols={20} rows={10}>
                            </textarea>
